...
function profile() {
  const [userData,setUserData] = useState({
    ...
    phone:'+12 3456 7890',
    address:{
      line1:'123 cross,someaddress',
      line2:'xyz Road , Delhi',
    },
    gender:'Male',
    dob:'2000-12-12'
  })
  ...
  return (
    <div className='max-w-lg flex flex-col gap-2 text-sm'>
     ...
     <p className='font-medium'>Address:</p>
     {
      ...
      <br /><input className='bg-gray-50' onChange={(e)=> setUserData(prev=>({...prev,address:{...prev.address,line2:e.target.value}}))} value={userData.address.line2} type="text" /></p>
     ...
     <div>
      ...
      <div className='grid grid-cols-[1fr_3fr] gap-y-2.5 mt-3 text-neutral-700'>
        ...
        {
          isEdit
          ? <select className='max-w-20 br-gray' onChange={(e)=>setUserData(prev=>({...prev,gender:e.target.value}))} value={userData.gender}>
